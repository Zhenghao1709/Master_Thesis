...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SCC detection on 2023-2024 test predictions."
    )
...
def main() -> None:
    ...
    episode_path = result_dir / f"scc_alarm_episodes_{suffix}.csv"
    performance_path = result_dir / f"scc_performance_{suffix}.json"
